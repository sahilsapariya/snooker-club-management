...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      deactivate_push_tokens: { Args: { p_tokens: string[] }; Returns: number }
      ...
      notifications_pending_push: {
        Args: { p_limit?: number; p_max_age?: string; p_max_attempts?: number }
        Returns: {
          body: string
          created_at: string
          entity_id: string
